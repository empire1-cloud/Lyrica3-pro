...
class FullRuntimeTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        os.environ.pop("ARCHISYNAPSE_API_KEY", None)
        os.environ["ARCHISYNAPSE_REGISTER_ENABLED"] = "false"
    ...
    async def test_runtime_creates_measured_distinct_artifacts_without_false_verification(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(track.proof.vics.status, EvidenceState.RECORDED)
            self.assertEqual(track.proof.archisynapse.status, EvidenceState.UNAVAILABLE)
