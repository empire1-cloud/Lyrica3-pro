...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative z-[2]">
      <div className="absolute top-[14%] left-1/2 -translate-x-1/2 w-[520px] h-[520px] rounded-full bg-[#f5a524]/10 blur-[120px] pointer-events-none"/>
      <div className="absolute bottom-[8%] right-[10%] w-[420px] h-[420px] rounded-full bg-[#ff5eac]/10 blur-[120px] pointer-events-none"/>
      ...
      <div className="panel rounded-[6px] p-10 w-full max-w-md relative" data-testid="login-card">
        ...
        <h1 className="font-display text-[36px] text-[#f3ece1] leading-none tracking-tight mt-2">
        ...
        <form onSubmit={submit} className="mt-8 space-y-4">
          <div>
            <div className="etched text-[#c9bfae] mb-2">Sovereign Handle</div>
            <input value={handle} onChange={e=>setHandle(e.target.value.toLowerCase())}
              ...
              className="w-full bg-[#0d0d10] border border-[#22222a] focus:border-[#f5a524] rounded-[3px] px-3 py-3 text-[#f3ece1] font-mono text-[13px] outline-none"/>
          </div>
          <div>
            <div className="etched text-[#c9bfae] mb-2">Passphrase</div>
          ...
          {err && <div className="text-[12px] text-[#ff5eac] font-mono" data-testid="login-error">{err}</div>}

          <button type="submit" disabled={loading}
            data-testid="login-submit-btn"
            className="w-full py-3.5 rounded-[3px] border-2 border-[#ff8a3d]
                       bg-gradient-to-b from-[#f5a524] to-[#b97316]
                       text-[#1a0e00] uppercase tracking-[0.28em] text-[12px] font-bold
          ...
          <button type="button" onClick={()=>setMode(mode === "login" ? "register" : "login")}
            ...
            className="w-full text-center text-[11px] font-mono text-[#8a8278] uppercase tracking-[0.2em] hover:text-[#ffd88a]">
